...
function cards() {
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_0__.getSourse)('http://localhost:3000/menu').then(data => {
    data.forEach(_ref => {
      let {
        img,
        altimg,
...
function cookies() {
  class CookieConsent {
    ...
    getItem = key => {
      const cookies = document.cookie.split(';').map(cookie => cookie.split('=')).reduce((acc, _ref) => {
        let [key, value] = _ref;
        return {
          ...acc,
          [key.trim()]: value
    ...
    setItem = (key, value) => {
      document.cookie = `${key}=${value};expires=Sun, 16 Jul 3568 06:23:41 GMT`;
    };
    hasConsented = () => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   getSourse: function() { return /* binding */ getSourse; },
...
/* harmony import */ var _modules_cookies__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/cookies */ "./js/modules/cookies.js");
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_cookies__WEBPACK_IMPORTED_MODULE_2__["default"])();
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_7__["default"])('.timer', '2023-05-31');
});
}();
/******/ })()
;
